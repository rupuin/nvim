...
keymap("n", "<leader>bd", "<cmd>bp | bd #<CR>", { noremap = true, silent = true, desc = "Delete current buffer" })
...
keymap("n", "<leader>rs", function()
	require("utils.functions").go_to_test()
end, { noremap = true, silent = true, desc = "Go to test" })
keymap("n", "<leader>ry", function()
	require("utils.functions").copy_file_path()
end, { noremap = true, silent = true, desc = "Copy file path" })
keymap("n", "<leader>fo", function()
	require("utils.functions").find_code_owners()
end, { noremap = true, silent = true, desc = "Find code owners" })
keymap("n", "<leader>ro", function()
	require("utils.functions").codeowners_to_clipboard()
end, { noremap = true, silent = true, desc = "Copy code owners to clipboard" })

keymap("n", "<leader>gp", function()
	require("utils.functions").find_pr_of_current_line()
end, { noremap = true, silent = true, desc = "Find PR of current line" })
